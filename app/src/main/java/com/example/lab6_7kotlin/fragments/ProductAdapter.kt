...
class ProductAdapter(fm: FragmentManager?, val pager:ViewPager, private val products: MutableList<ProductCount>, private val construct : (ProductCount, ProductAdapter)-> ProductFragment) : FragmentPagerAdapter(fm!!) {
